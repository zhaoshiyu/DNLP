...
class TextLoader(object):
    def __init__(self, model_dir=None, data_file=None, vocab_corpus_file=None, batch_size=None, seq_length=None, encoding='utf8'):
    ...
    def preprocess_tensor(self, data):
        tensor_x = np.array(list(map(self.transfer.text_to_tensor, data['text'])))
